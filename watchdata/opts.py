...
import watchdata.common.config
...
_opt_lists = [
    ('rabbitmq', watchdata.common.config.rabbit_opts),
    (None, build_list([
        watchdata.common.config.storage_opt,
    ]))
]


def list_opts():
    """Return a list of oslo.config options available in watchdata.
    ...
    This function is also discoverable via the 'watchdata' entry point
