...
sys.path.insert(0, os.path.abspath('../../watchdata'))
...
#
# Version info
#from watchdata.version import version_info as s_version
...
htmlhelp_basename = 'watchdataDoc'
...
#latex_documents = [
#    ('index', 'watchdata.tex', u'Watchdata',
